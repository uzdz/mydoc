/**
 Core script to handle the entire theme and common functions
 **/
var App = function() {
    // IE mode
    var isRTL = false;
    ...
    return {
        ...
        init : function() {
            ...
            //IMPORTANT!!!: Do not modify the common handlers call order.
            //common handlers
            handleInit();
        ...
        //main function to initiate common javascript after ajax complete
        initAjax : function() {
            handleSelect2();
            // handle custom Select2 dropdowns
            handleDropdowns();
